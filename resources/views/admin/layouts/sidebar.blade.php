<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Route::is('admin.product-category.*')||Route::is('admin.product.*')||Route::is('admin.coupon.*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.coupon.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.coupon.index') }}""><i class="fas fa-angle-right"></i> Coupon</a>
                    </li>
                </ul>
            </li>
