...
->group(function () {
    ...
    Route::get('skill/index', [AdminSkillController::class, 'index'])->name('skill.index');
    ...
    Route::get('product/features/{id}', [AdminProductController::class, 'features'])->name('product.features');
